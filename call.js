//Can I access one memory location to another memory location...
// ANS is NO.
//If we want to set relationship between one memory loc to another memory loc
/*
    let obj = {
        "num1" : 10
    };
...
//merging function memory n jdon memory using bind and newmemory oc will be created
